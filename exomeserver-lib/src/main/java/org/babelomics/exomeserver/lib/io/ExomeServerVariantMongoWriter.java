 ...
 */
public class ExomeServerVariantMongoWriter extends VariantDBWriter {
    ...
    public ExomeServerVariantMongoWriter(VariantSource source, MongoCredentials credentials) {
        this(source, credentials, "variants", "files");
    }

    public ExomeServerVariantMongoWriter(VariantSource source, MongoCredentials credentials, String variantsCollection, String filesCollection) {
