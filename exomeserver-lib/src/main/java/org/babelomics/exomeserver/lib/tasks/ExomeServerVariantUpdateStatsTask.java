 ...
 */
public class ExomeServerVariantUpdateStatsTask extends Task<Variant> {

    private final VariantSource source;
    private final VariantDBAdaptor dbAdaptor;

    public ExomeServerVariantUpdateStatsTask(MongoCredentials credentials, VariantSource source) throws UnknownHostException {
    ...
    public ExomeServerVariantUpdateStatsTask(VariantSource source) {
        this.source = source;
        this.dbAdaptor = null;
