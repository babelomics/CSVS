 ...
 */
public class PVSVariantSourceMongoDBAdaptor implements VariantSourceDBAdaptor {
    ...
    public PVSVariantSourceMongoDBAdaptor(MongoCredentials credentials) throws UnknownHostException {
        // Mongo configuration
        ...
        variantSourceConverter = new PVSDBObjectToVariantSourceConverter();
    }
