 ...
 */
public class PVSStudyMongoDBAdaptor implements PVSStudyDBAdaptor {
    private final MongoDataStoreManager mongoManager;
    private final MongoDataStore db;

    public PVSStudyMongoDBAdaptor(MongoCredentials credentials) throws UnknownHostException {
