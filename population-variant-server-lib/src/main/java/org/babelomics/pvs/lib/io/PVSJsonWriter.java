...
import org.babelomics.pvs.lib.json.*;
 ...
 */
public class PVSJsonWriter implements VariantWriter {
    ...
    public PVSJsonWriter(VariantSource source, Path outdir) {
        this.source = source;
    ...
    public boolean pre() {
        ...
        jsonObjectMapper.addMixInAnnotations(VariantSource.class, PVSVariantSourceJsonMixin.class);
