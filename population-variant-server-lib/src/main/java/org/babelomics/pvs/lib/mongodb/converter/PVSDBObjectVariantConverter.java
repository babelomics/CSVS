 ...
 */
public class PVSDBObjectVariantConverter implements ComplexTypeConverter<Variant, DBObject> {
     ...
     */
    public PVSDBObjectVariantConverter() {
        this(null);
    }
     ...
     */
    public PVSDBObjectVariantConverter(DBObjectToVariantSourceEntryConverter archivedVariantFileConverter) {
