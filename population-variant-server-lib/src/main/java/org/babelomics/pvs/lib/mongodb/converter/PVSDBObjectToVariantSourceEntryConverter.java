 ...
 */
public class PVSDBObjectToVariantSourceEntryConverter implements ComplexTypeConverter<VariantSourceEntry, DBObject> {
    ...
    private PVSDBObjectToVariantStatsConverter statsConverter;
     ...
     */
    public PVSDBObjectToVariantSourceEntryConverter() {
     ...
     */
    public PVSDBObjectToVariantSourceEntryConverter(boolean compressSamples, List<String> samples,
                                                    PVSDBObjectToVariantStatsConverter statsConverter) {
    ...
    public PVSDBObjectToVariantSourceEntryConverter(boolean includeSamples,
                                                    PVSDBObjectToVariantStatsConverter statsConverter, List<String> samples) {
        ...
        if (object.containsField(ATTRIBUTES_FIELD)) {
            ...
            if (((DBObject) object.get(ATTRIBUTES_FIELD)).containsField("src")) {
                ...
                try {
                    ...
                    Logger.getLogger(PVSDBObjectToVariantSourceEntryConverter.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
