 ...
 */
public class PVSDBObjectToVariantConverter implements ComplexTypeConverter<Variant, DBObject> {
    ...
    private PVSDBObjectToVariantSourceEntryConverter archivedVariantFileConverter;
     ...
     */
    public PVSDBObjectToVariantConverter() {
        this(null);
    }
     ...
     */
    public PVSDBObjectToVariantConverter(PVSDBObjectToVariantSourceEntryConverter archivedVariantFileConverter) {
